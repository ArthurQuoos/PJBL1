...
public class JwtService {
    ...
    public String generateToken(Usuario user) {
        //Alterei um pouco o codigo aqui, criei uma funcao para a chave  
        return Jwts.builder()
    ...
    public String extractEmail(String token) {
        return Jwts.parser()
                ...
                .build()
                .parseSignedClaims(token) // abre o token
                .getPayload()
                .getSubject(); // pega o "subject" = e-mail
    }
    ...
    public boolean validateToken(String token) {
        ...
        try {
            ...
            // 2. A biblioteca JJWT joga uma exceção automaticamente se o token estiver expirado ou a assinatura for inválida.
                    .parseSignedClaims(token); // Tenta abrir o token
